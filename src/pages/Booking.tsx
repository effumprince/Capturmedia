          ...
          <div className="grid lg:grid-cols-[1fr_1.3fr] gap-10 lg:gap-16 items-start">
            ...
            <Reveal variant="left">
              ...
              <div className="border border-ink/10 rounded-sm p-8 mb-6">
                <InfoRow title="Email">
                  <a href="mailto:hello@capturamedia.studio" className="hover:text-shutter">
                    hello@capturamedia.studio
                  </a>
                </InfoRow>
                <InfoRow title="Phone & WhatsApp">
                  <a href="tel:+233000000000" className="hover:text-shutter">
                    +233 00 000 0000
                  </a>
                </InfoRow>
...
function InfoRow({ title, children, last = false }: { title: string; children: React.ReactNode; last?: boolean }) {
  return (
